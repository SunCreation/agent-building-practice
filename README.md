...
- [Python Harness Lab](harness-lab/README.md): 실제 Python 하네스, Terminal-Bench Pro 고정 10문항, 점수 모니터·비교 실험과 제출 양식.
- [Card News Studio](card-news-studio/README.md): Claude Agent SDK / OpenCode CLI, 프로젝트별 세션·부분 수정·PNG/PDF·웹앱·Tailscale Serve.

각 폴더의 README에서 사용 방법을 확인하세요. 설계 키트는 문서로 구성되어 있으며, 카드뉴스 프로젝트에는 `uv.lock`을 포함했습니다. API 키, 인증 정보, 개인 작업 기록은 포함하지 않습니다.
