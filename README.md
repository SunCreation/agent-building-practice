...
명세를 작성해 자기 하네스를 만드는 설계 키트, Python 참고 구현, 기존 SDK·CLI를 조립하는 카드뉴스 제작기입니다.

- [Harness Design Kit](harness-design-kit/README.md): 미완성 PRD, 설계 질문, 언어·플랫폼 선택, 인터페이스와 검증 시나리오. 여기서 시작합니다.
- [Agent Harness Practice](agent-harness-practice/README.md): OpenAI API / Ollama, 직접 구현한 도구 호출 루프·승인·세션·테스트.
- [Card News Studio](card-news-studio/README.md): Claude Agent SDK / OpenCode CLI, 프로젝트별 세션·부분 수정·PNG/PDF·웹앱·Tailscale Serve.

각 폴더의 README에서 사용 방법을 확인하세요. 설계 키트는 문서로 구성되어 있으며, Python 참고 프로젝트에는 `uv.lock`을 포함했습니다. API 키, 인증 정보, 개인 작업 기록은 포함하지 않습니다.
